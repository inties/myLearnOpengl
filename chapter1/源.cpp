...
// *************加载着色器**************
// ********************************************
    Shader ourShader("chapter1/vs.vs", "chapter1/fs.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            model = glm::rotate(model, glm::radians(2*(float)glfwGetTime() * glm::radians(50.0f)+ glm::radians(i*50.0f)), glm::vec3(1.0f, 0.3f, 0.5f));
